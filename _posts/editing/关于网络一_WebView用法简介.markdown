**<font size=5>一、WebView简单介绍**

**WebView控件可以使我们自己的app嵌入一个浏览器，并渲染各种各样的网页**
<hr>

**<font size=5>二、WebView使用方法**

**1.因为要访问网络，所以必须先添加联网权限.否则<font color=re>出现错误：<font color=red>Web page not available</font>**
```java
...
**<font size=4>WebViewClient基本使用**：提供网页加载各个阶段的通知
```java
