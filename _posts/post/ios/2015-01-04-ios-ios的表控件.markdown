...
![](http://itCatface.github.io/img/IOS/IOS005-表/01概述.jpg)

# 第一章、普通表

## 第一节、简单TableView
  
  > ![](http://itCatface.github.io/img/IOS/IOS005-表/02简单TV.jpg)
...
3. **上述步骤中单元格复用方法**
    ...
    > ![](http://itCatface.github.io/img/IOS/IOS005-表/03单元格复用.jpg)
		
		
## 第二节、自定义单元格

> [](http://itCatface.github.io/img/IOS/IOS005-表/04自定义单元格.jpg)

- **只需更改 `Delegate` 中单元格类为自定义 `Cell` 类即可**

	> ![](http://itCatface.github.io/img/IOS/IOS005-表/05自定义单元格02.jpg)
...
## 第三节、添加搜索栏
 ...
 > ![](http://itCatface.github.io/img/IOS/IOS005-表/06Bar01.jpg)
...
> ![](https://imgconvert.csdnimg.cn/aHR0cDovL3VwbG9hZC1pbWFnZXMuamlhbnNodS5pby91cGxvYWRfaW1hZ2VzLzk3NTM1NC01NmIzYjYyY2UwZDk0NzEwLmpwZw)
